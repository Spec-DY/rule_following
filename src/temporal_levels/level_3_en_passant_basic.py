"""
Temporal Level 3: En Passant Basic
...
class TemporalLevel3(TemporalLevelBase):
    """Level 3: En passant basic conditions"""

    def __init__(self,
                 base_output_dir: str = "./output/temporal_level_3",
                 n_cases: int = 100,
                 seed: int = 42,
    ...
    def generate_test_cases(self) -> List[Dict]:
        ...
        print(
            f"\nGenerating Level 3 test cases (n_cases={self.n_cases}, seed={self.seed})")
        print("=" * 60)

        generator = Level3Generator(seed=self.seed)
